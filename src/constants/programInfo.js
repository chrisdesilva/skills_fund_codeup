...
export const leadContent = {
    ...
    paragraph: `${schoolName} offers a full-stack coding bootcamp to prepare students for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $26,500 for Codeup's Full Stack Bootcamp tuition and up to $6,000 for cost of living."
